...
# register button
login_button = customtkinter.CTkButton(frameRight, text = "REGISTER", corner_radius=35, fg_color="#0b5394")
login_button.place(relx = 0.29, rely = 0.91, anchor = "center")


# back button
login_button = customtkinter.CTkButton(frameRight, text = "Go Back", corner_radius=35, fg_color="#0b5394")
login_button.place(relx = 0.65, rely = 0.91, anchor = "center")
