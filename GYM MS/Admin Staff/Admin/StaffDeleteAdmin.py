...
# delete button
delete_button = customtkinter.CTkButton(frameRight, text = "DELETE", corner_radius=35, fg_color="#0b5394",cursor="hand2")
delete_button.place(relx = 0.29, rely = 0.91, anchor = "center")
